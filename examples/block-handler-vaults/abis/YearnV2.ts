export const YEARN_V2_ABI = [{
  ...
  'inputs': [{ 'name': 'oldVersion', 'type': 'address', 'indexed': true }, {
    'name': 'newVersion',
    'type': 'address',
    'indexed': true,
  }],
  ...
  'inputs': [{ 'name': 'healthCheck', 'type': 'address', 'indexed': true }],
  'anonymous': false,
  'type': 'event',
}, {
  ...
  'inputs': [
    ...
    { 'name': 'partner_fee', 'type': 'uint256', 'indexed': false },
  ...
  'inputs': [{ 'name': 'oldVersion', 'type': 'address' }, {
    'name': 'newVersion',
    'type': 'address',
  }],
  'outputs': [],
